...
from PyQt6.QtWidgets import (QDialog, QVBoxLayout, QHBoxLayout, QPushButton, QLabel, 
                             QLineEdit, QTextEdit, QComboBox, QProgressBar, QMessageBox, 
...
class ModelTestDialog(QDialog):
    ...
    def on_model_load_error(self, error_message):
        ...
        QMessageBox.critical(self, "Loading Error", f"Failed to load model: {error_message}")
    ...
    def unload_model(self):
        ...
        if self.pipeline:
            ...
            QMessageBox.information(self, "Model Unloaded", "Model has been unloaded and memory freed")
    ...
    def check_memory_usage(self):
        ...
        try:
            ...
            self.memory_info_label.setText(f"Memory: {used_gb:.1f}GB/{total_gb:.1f}GB ({percent:.0f}%)")
        except:
    ...
    def generate_text(self):
        ...
        try:
            ...
            result = self.pipeline(input_text, max_new_tokens=max_length, temperature=temperature)
    ...
    def translate_text(self):
        ...
        QMessageBox.information(self, "Translation", "Translation features are now available in the 🌐 Web Interface tab!")
    ...
    def send_chat_message(self):
        ...
        try:
            ...
            result = self.pipeline(full_prompt, max_new_tokens=max_length, temperature=temperature)
            ...
            if isinstance(result, list) and len(result) > 0:
                ...
                self.chat_history.append("<b>Assistant:</b> Sorry, I couldn't generate a response.")
    ...
    def save_chat_history(self):
        ...
        try:
            ...
            file_path, _ = QFileDialog.getSaveFileName(
                self, "Save Chat History", f"chat_{self.model_name}.txt", "Text Files (*.txt)"
            )
            
            if file_path:
                with open(file_path, 'w', encoding='utf-8') as f:
                    f.write(self.chat_history.toPlainText())
                QMessageBox.information(self, "Success", f"Chat history saved to {file_path}")
        except Exception as e:
    ...
    def load_chat_history(self):
        ...
        try:
            ...
            if file_path:
                ...
                QMessageBox.information(self, "Success", f"Chat history loaded from {file_path}")
        except Exception as e:
    ...
    def closeEvent(self, event):
        ...
        if self.gradio_manager:
            try:
                ...
                print(f"Warning: Could not stop Gradio interface for {self.model_name}: {e}")
