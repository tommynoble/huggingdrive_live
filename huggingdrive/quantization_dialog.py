...
from PyQt6.QtWidgets import (
    ...
    QSpinBox, QPushButton, QGroupBox, QTextEdit, QProgressBar
)
...
class QuantizationDialog(QDialog):
    ...
    def init_ui(self):
        ...
        # Validation
        is_valid, validation_msg = self.converter_manager.validate_model_for_conversion(self.model_path)
        self.validation_label = QLabel(f"Status: {'✅ Valid' if is_valid else '❌ Invalid'}")
        self.validation_label.setStyleSheet("color: green;" if is_valid else "color: red;")
    ...
    def update_size_estimate(self):
        ...
        try:
            ...
            if input_mb > 0 and output_mb > 0:
                ...
                self.size_estimate_label.setStyleSheet("color: #28a745; font-weight: bold;")
            else:
